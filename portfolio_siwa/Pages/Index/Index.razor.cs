...
namespace portfolio_siwa.Pages.Index
{
    public partial class Index
    {
        ...
        protected override void OnInitialized()
        {
            ...
            this.TitreProjetLibPais = "PAÍS TV";
            this.DescriptionProjetLibPais = new MarkupString("<a class='projet' style='color: #2E9CCA;' href='https://ioa-pais.fr'>PAÍS TV</a> est la mémoire vivante de l’Occitanie en Aveyron. Plongez au cœur d’un patrimoine millénaire à travers le regard des Aveyronnais. Vitrine numérique de l’<strong>Institut occitan de l’Aveyron</strong>, cette plateforme regroupe <strong>30 ans de collectage</strong> : des milliers de témoignages, d’images, de récits et d’instants de vie. Chaque commune y prend vie : son histoire, ses paysages, ses habitants et leurs voix. Découvrez des <strong>contes oubliés</strong>, des <strong>histoires du quotidien</strong> et des <strong>savoirs ancestraux</strong>, captés pour préserver et transmettre l’âme occitane. Un trésor culturel à explorer, partager… et faire vivre.");
